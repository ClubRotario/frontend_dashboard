...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'posts', component: PostsComponent, data: { title: 'Posts', description: 'Gestiona los posts que se han creado, decido si quieres que estén visibles al publico o si lo prefieres edítalos o elimínalos.', image: 'blog.svg' }},
      { path: 'users', component: PostsComponent, data: { title: 'Usuarios', description: 'Controla los usuarios que pueden acceder al sistema, crea una cuenta de ser necesario o si deseas que un usuario no inicie sesión mas en el sistema puedes eliminarlo.', image: 'users.svg' }},
